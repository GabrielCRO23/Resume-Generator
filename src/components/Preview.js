      ...
      <div>
        <Container maxWidth="xl">
          {personalInfo.map((personal, index) => (
            <React.Fragment key={index}>
              ...
              >
                ...
                <Link
                  href={personal.websitethree}
                  color="#000000"
                  underline="none"
                  variant="subtitle2"
                >
                  {personal.websitethree}
                </Link>
              </Box>
            </React.Fragment>
          ))}
          ...
          {skills.length > 0 && (
            <React.Fragment>
              <Typography
                sx={{ lineHeight: 0.5, fontWeight: 700 }}
                variant="h6"
                align="left"
              >
                Skills
              ...
              <hr></hr>
              <Typography ml={5} sx={{ lineHeight: 0.5 }} variant="h6">
                {parse(skills)}
              </Typography>
            </React.Fragment>
          )}
          ...
          {projects.map((project, index) => (
            <React.Fragment key={index}>
              <Box sx={{ display: "flex" }}>
                ...
                <Typography
                  sx={{ lineHeight: 0.5, marginLeft: "auto" }}
                  variant="h6"
                >
                  {project.tech}
                </Typography>
          ...
          {formFields.map((formField, index) => (
            <React.Fragment key={index}>
              ...
              <Box sx={{ display: "flex" }}>
                ...
                <Typography
                  sx={{ lineHeight: 1.5, marginLeft: "auto" }}
                  variant="h6"
                >
            ...
            <React.Fragment key={index}>
              <Box sx={{ display: "flex" }}>
                ...
                <Typography
                  ...
                  variant="h6"
                >
                  {formTwoField.location}
                </Typography>
              </Box>
              <Box sx={{ display: "flex" }}>
                <Typography ml={5} sx={{ lineHeight: 1.5 }} variant="h6">
                  {formTwoField.certification}
                </Typography>
                <Typography
                  sx={{ lineHeight: 1.5, marginLeft: "auto" }}
                  variant="h6"
                >
                  {formTwoField.startdate}&nbsp;-&nbsp;{formTwoField.enddate}
                </Typography>
              </Box>
            </React.Fragment>
          ))}
